...
public class Term extends Activity {
    ...
    public static final String EXTRA_WINDOW_ID = "kevinboone.androidterm.window_id";
    ...
    public void onCreate(Bundle icicle) {
        ...
        mWifiLock = wm.createWifiLock(WifiManager.WIFI_MODE_FULL_HIGH_PERF, TermDebug.LOG_TAG); //kb
    ...
    private TermSession createTermSession() {
        ...
        String iInitialCommand = getIntent().getStringExtra("kevinboone.androidterm.iInitialCommand");
