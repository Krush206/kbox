...
package kevinboone.androidterm.session;
...
import kevinboone.androidterm.TermDebug;
import kevinboone.androidterm.model.UpdateCallback;
import kevinboone.androidterm.util.ByteQueue;
import kevinboone.androidterm.util.TermSettings;
...
public class TermSession {
    ...
    private static final String DEFAULT_SHELL = "/data/data/kevinboone.androidterm/lib/libkbox_shell.so";
    ...
    private void sendInitialCommand(String initialCommand) {
        if (initialCommand == null || initialCommand.equals("")) {
            //KB -- don't sent initial command if none set
