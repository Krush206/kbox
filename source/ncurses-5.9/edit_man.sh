...
*.[0-9]*)
	...
	if test ! -f /home/kevin/source/kbox_term/source/ncurses-5.9/man_alias.sed ; then
cat >>/home/kevin/source/kbox_term/source/ncurses-5.9/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/kevin/source/kbox_term/source/ncurses-5.9/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/kevin/source/kbox_term/source/ncurses-5.9/man_alias.sed | sort -u`
	...
	sed	-f /home/kevin/source/kbox_term/source/ncurses-5.9/man_alias.sed \
		< $i >$TMP
